// ПРИМЕР ДЛЯ ПРОВЕРКИ РАБОТЫ ПЕРЕДАТЧИКА (FS1000A) НА РАЗНЫХ ПЛАТАХ ARDUINO
//
...
char                     i[]="Hello 11111";               // Создаём массив для передачи данных
...
//  =============================== ПЕРЕДАТЧИК
    ...
    radioTX.openWritingPipe(3);                           // Открываем 5 трубу для передачи данных (передатчик может передавать данные только по одной из труб: 0...7). Если повторно вызвать функцию openWritingPipe указав другой номер трубы, то передатчик начнёт передавать данные по вновь указанной трубе
//  =============================== ПРИЁМНИК
