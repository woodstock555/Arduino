...
#define KOL_LED       60         // Сколько светодиодов в гирлянде при первом включении
...
#define IR_MAX_LEDS   60         // Максимальное количество светодиодов при работе с пультом должно быть больше
// или равно KOL_LED
...
#define POWER_I       2250        // Ток блока питания в милиАмперах
